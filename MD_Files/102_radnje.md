...
>>> n
= 17 + 25 
>>> if n print('broj je paran') else: print('broj je
neparan')
...
>>> x = 16 
# pridruži vrijednost 16 novoj varijabli x 
>>> y = 26
# pridruži vrijednost 26 novoj varijabli y 
>>> x + y
# rezultat ovog izračuna nismo pridružili niti jednoj varijabli 42 
>>> z = x + y
# definiraj novu varijablu z kako bi se kasnije mogao pozvati na rezultat 
>>> print(z) # pozovi se na vrijednost varijable z 42

>>> z = y - x
# pridruži novu vrijednost varijabli z 
>>> print(z)
# pozovi se na vrijednost varijable z 10


>>> text = input("Upiši neki tekst: ")
# pridruži korisnički unos varijabli "text" Upiši neki tekst: neću 
>>> print(text)
...
>>> x += 2
# isto što i x = x + 2 samo kraće za pisati 
>>> print(x) 5 
>>> x *= 2
# isto što i x = x * 2 samo kraće za pisati 
>>> print(x) 10 
...
>>> 2 + 2 * 3 
# prvo se množi a onda zbraja 8 
>>> (2 + 2) * 3
# prvo se evaluira operacija u zagradama, a tek onda množi 12
```
...
3.1416 
>>> round(pi)
# obavezan parametar, što se zaokružuje, bez toga radnja nema smisla 3 
>>> round(pi, 2)
# drugi parametar je opcionalan, na koliko decimala 3.14
```
...
parametrilisting:pozicijski_i_imenovani_parametri 
>>> n = 3.142

>>> round(number=n)
# bilo koji parametar možemo i imenovati 3
>>> round(number=n, ndigits=2)
# sintaksa je ista pridruživanj vrijednosti varijabli 3.14 
>>> round(ndigits=2, number=n)
# kada su parametri imenovani, pozicija je nebitna 3.14
```
...
``` python
Funkcija print s više parametara i definiranim sep i endlisting:print_sep_end 
